...
// Update user profile
router.put('/profile', clerkAuth, upload.single('image'), userController.updateProfile);
// after sign in page
router.put("/profile/custom", clerkAuth, upload.single("image"), userController.updateProfileCustom); 

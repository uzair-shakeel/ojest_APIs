...
// Normal User Routes
router.post('/', clerkAuth, upload.array('images', 10), carController.addCar); // Max 10 images
router.get('/my-cars/:userId', clerkAuth, carController.getCarsByUserId);
router.put('/:carId', clerkAuth, upload.array('images', 10), carController.updateCar);
